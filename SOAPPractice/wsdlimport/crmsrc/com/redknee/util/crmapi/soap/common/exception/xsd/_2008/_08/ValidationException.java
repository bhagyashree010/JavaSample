 ...
 *         &lt;element name="entries" type="{http://soap.crmapi.util.redknee.com/common/exception/xsd/2008/08}ValidationExceptionEntry" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends CRMException
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "entries", namespace = "http://soap.crmapi.util.redknee.com/common/exception/xsd/2008/08", type = JAXBElement.class, required = false)
    })
     ...
     * line 59 of http://pun1lvm19:11648/RedkneeSoap_v3_0/services/MobileNumberService?xsd=Common_fault_types_1_0.xsd
     ...
     * {@link JAXBElement }{@code <}{@link ValidationExceptionEntry }{@code >}
     * 
     * 
     */
